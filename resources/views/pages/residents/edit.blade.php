                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="alamat" name="alamat" rows="3">{{ old('alamat', $resident->alamat) }}</textarea>
                        </div>

                        <div class="form-group mb-3">
                            <label for="status_kepemilikan_rumah">Status Kepemilikan Rumah</label>
                            <select class="form-control" name="status_kepemilikan_rumah">
                                <option value="Milik Sendiri" {{ old('status_kepemilikan_rumah', $resident->status_kepemilikan_rumah) == 'Milik Sendiri' ? 'selected' : '' }}>Milik Sendiri</option>
                                <option value="Kontrak/Sewa" {{ old('status_kepemilikan_rumah', $resident->status_kepemilikan_rumah) == 'Kontrak/Sewa' ? 'selected' : '' }}>Kontrak/Sewa</option>
                                <option value="Menumpang" {{ old('status_kepemilikan_rumah', $resident->status_kepemilikan_rumah) == 'Menumpang' ? 'selected' : '' }}>Menumpang</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="kepemilikan_aset" name="kepemilikan_aset"
                                   value="{{ old('kepemilikan_aset', $resident->kepemilikan_aset) }}">
                        </div>
