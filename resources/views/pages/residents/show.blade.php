...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Detail Asset {{$resident->nama_kepala_keluarga}}</h1>
        <div>
            <a href="{{ route('residents.index') }}" class="btn btn-sm btn-secondary shadow-sm">Kembali</a>
            <a href="{{ route('residents.pdf', $resident->id) }}" class="btn btn-sm btn-danger shadow-sm">Download PDF</a>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center">Belum ada anggota keluarga</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
